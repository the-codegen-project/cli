...
running command...
$ codegen (--version)
@the-codegen-project/cli/0.73.0 linux-x64 node-v22.23.1
...
_See code: [src/commands/base.ts](https://github.com/the-codegen-project/cli/blob/v0.73.0/src/commands/base.ts)_
...
_See code: [src/commands/generate.ts](https://github.com/the-codegen-project/cli/blob/v0.73.0/src/commands/generate.ts)_
...
_See code: [src/commands/init.ts](https://github.com/the-codegen-project/cli/blob/v0.73.0/src/commands/init.ts)_
...
_See code: [src/commands/telemetry.ts](https://github.com/the-codegen-project/cli/blob/v0.73.0/src/commands/telemetry.ts)_
