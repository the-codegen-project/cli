...
running command...
$ codegen (--version)
@the-codegen-project/cli/0.18.8 linux-x64 node-v18.20.4
...
_See code: [src/commands/generate.ts](https://github.com/the-codegen-project/cli/blob/v0.18.8/src/commands/generate.ts)_
...
_See code: [src/commands/init.ts](https://github.com/the-codegen-project/cli/blob/v0.18.8/src/commands/init.ts)_
