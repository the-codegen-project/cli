...
running command...
$ codegen (--version)
@the-codegen-project/cli/1.0.0 linux-x64 node-v18.20.8
...
_See code: [src/commands/generate.ts](https://github.com/the-codegen-project/cli/blob/v1.0.0/src/commands/generate.ts)_
...
_See code: [src/commands/init.ts](https://github.com/the-codegen-project/cli/blob/v1.0.0/src/commands/init.ts)_
...
_See code: [src/commands/telemetry.ts](https://github.com/the-codegen-project/cli/blob/v1.0.0/src/commands/telemetry.ts)_
