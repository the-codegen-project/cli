...
running command...
$ codegen (--version)
@the-codegen-project/cli/0.18.4 win32-x64 node-v20.15.1
...
_See code: [src/commands/generate.ts](https://github.com/the-codegen-project/cli/blob/v0.18.4/src/commands/generate.ts)_
...
_See code: [src/commands/init.ts](https://github.com/the-codegen-project/cli/blob/v0.18.4/src/commands/init.ts)_
