...
running command...
$ codegen (--version)
@the-codegen-project/cli/0.70.1 linux-x64 node-v22.22.2
...
_See code: [src/commands/base.ts](https://github.com/the-codegen-project/cli/blob/v0.70.1/src/commands/base.ts)_
...
_See code: [src/commands/generate.ts](https://github.com/the-codegen-project/cli/blob/v0.70.1/src/commands/generate.ts)_
...
_See code: [src/commands/init.ts](https://github.com/the-codegen-project/cli/blob/v0.70.1/src/commands/init.ts)_
...
_See code: [src/commands/telemetry.ts](https://github.com/the-codegen-project/cli/blob/v0.70.1/src/commands/telemetry.ts)_
