...
The other side of the same document: generating typed Express handler stubs with the `http_server` protocol, and driving them with the `http_client` generated from that same document.
