...
class OrderUpdatedHeaders {
  ...
  public static fromJson(obj: Record<string, unknown>): OrderUpdatedHeaders {
    const instance = new OrderUpdatedHeaders({} as any);
  ...
  public static unmarshal(json: string | object): OrderUpdatedHeaders {
    const obj = typeof json === "object" ? json : JSON.parse(json);
    return OrderUpdatedHeaders.fromJson(obj as Record<string, unknown>);
  }
  public static theCodeGenSchema = {"type":"object","required":["x-correlation-id","x-order-id","x-customer-id"],"properties":{"x-correlation-id":{"type":"string","format":"uuid"},"x-order-id":{"type":"string","format":"uuid"},"x-customer-id":{"type":"string","format":"uuid"},"x-source-service":{"type":"string"}},"$id":"OrderUpdatedHeaders","$schema":"http://json-schema.org/draft-07/schema"};
