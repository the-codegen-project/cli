...
type OrderLifecyclePayload = OrderCreated | OrderUpdated | OrderCancelled;

export function unmarshal(json: any): OrderLifecyclePayload {
...
export function marshal(payload: OrderLifecyclePayload) {
