...
class BankAccount {
  ...
  public static theCodeGenSchema = {"type":"object","properties":{"id":{"type":"string"},"iban":{"type":"string"},"isDefault":{"type":"boolean"}},"$id":"BankAccount","$schema":"http://json-schema.org/draft-07/schema"};
