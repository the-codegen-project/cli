...
interface GetConnectModelInterface {
  referenceId?: string
...
class GetConnectModel {
  ...
  constructor(input: GetConnectModelInterface) {
  ...
  public static fromJson(obj: Record<string, unknown>): GetConnectModel {
    const instance = new GetConnectModel({} as any);
  ...
  public static unmarshal(json: string | object): GetConnectModel {
    const obj = typeof json === "object" ? json : JSON.parse(json);
    return GetConnectModel.fromJson(obj as Record<string, unknown>);
  }
  public static theCodeGenSchema = {"type":"object","properties":{"referenceId":{"type":"string"},"safepayAccountId":{"type":"string"},"status":{"type":"string","enum":["pending","connected","expired"]}},"$id":"GetConnectModel","$schema":"http://json-schema.org/draft-07/schema"};
...
export { GetConnectModel, GetConnectModelInterface };