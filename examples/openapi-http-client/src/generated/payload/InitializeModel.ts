...
interface InitializeModelInterface {
  referenceId?: string
  connectUrl?: string
...
class InitializeModel {
  ...
  constructor(input: InitializeModelInterface) {
  ...
  public static fromJson(obj: Record<string, unknown>): InitializeModel {
  ...
  public static unmarshal(json: string | object): InitializeModel {
    ...
    return InitializeModel.fromJson(obj as Record<string, unknown>);
  }
...
export { InitializeModel, InitializeModelInterface };