...
class ReservedUndefined {
  ...
  public static unmarshal(json: string | object): ReservedUndefined {
    const obj = typeof json === "object" ? json : JSON.parse(json);
    const instance = new ReservedUndefined({} as any);
