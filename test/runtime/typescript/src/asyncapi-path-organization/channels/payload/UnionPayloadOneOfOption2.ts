...
class UnionPayloadOneOfOption2 {
  ...
  public static fromJson(obj: Record<string, unknown>): UnionPayloadOneOfOption2 {
    const instance = new UnionPayloadOneOfOption2({} as any);
  ...
  public static unmarshal(json: string | object): UnionPayloadOneOfOption2 {
    const obj = typeof json === "object" ? json : JSON.parse(json);
    return UnionPayloadOneOfOption2.fromJson(obj as Record<string, unknown>);
  }
...
export type { UnionPayloadOneOfOption2Interface };