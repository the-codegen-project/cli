...
class PetTag {
  ...
  constructor(input: PetTagInterface) {
    this._id = input.id;
  ...
  public static fromJson(obj: Record<string, unknown>): PetTag {
  ...
  public static unmarshal(json: string | object): PetTag {
    ...
    return PetTag.fromJson(obj as Record<string, unknown>);
  }
