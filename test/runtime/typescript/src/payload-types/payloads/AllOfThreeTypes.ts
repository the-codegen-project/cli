...
class AllOfThreeTypes {
  ...
  public marshal() : string {
    ...
    if(this.createdBy !== undefined) {
      json += `"createdBy": ${typeof this.createdBy === 'number' || typeof this.createdBy === 'boolean' ? this.createdBy : JSON.stringify(this.createdBy)},`;
    }
    if(this.updatedBy !== undefined) {
      json += `"updatedBy": ${typeof this.updatedBy === 'number' || typeof this.updatedBy === 'boolean' ? this.updatedBy : JSON.stringify(this.updatedBy)},`;
    }
  ...
  public static unmarshal(json: string | object): AllOfThreeTypes {
    ...
    if (obj["createdBy"] !== undefined) {
      instance.createdBy = obj["createdBy"];
    }
    if (obj["updatedBy"] !== undefined) {
      instance.updatedBy = obj["updatedBy"];
    }
