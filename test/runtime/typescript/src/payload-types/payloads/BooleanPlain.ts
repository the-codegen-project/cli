...
/**
 * A plain boolean type
 */
type BooleanPlain = boolean;

export function unmarshal(json: string): BooleanPlain {
  return JSON.parse(json) as BooleanPlain;
}
export function marshal(payload: BooleanPlain): string {
  return JSON.stringify(payload);
}
export const theCodeGenSchema = {"type":"boolean","$schema":"http://json-schema.org/draft-07/schema","description":"A plain boolean type","$id":"BooleanPlain"};
