...
export const theCodeGenSchema = {"type":"string","$schema":"http://json-schema.org/draft-07/schema","format":"date-time","description":"String with date-time format (ISO 8601)","$id":"FormatDateTime"};
