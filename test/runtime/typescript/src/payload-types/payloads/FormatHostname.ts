...
export function unmarshal(json: string): FormatHostname {
  return JSON.parse(json) as FormatHostname;
}
export function marshal(payload: FormatHostname): string {
  return JSON.stringify(payload);
}
export const theCodeGenSchema = {"type":"string","$schema":"http://json-schema.org/draft-07/schema","format":"hostname","description":"String with hostname format","$id":"FormatHostname"};
