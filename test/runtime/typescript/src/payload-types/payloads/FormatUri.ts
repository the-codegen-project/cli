...
export function unmarshal(json: string): FormatUri {
  return JSON.parse(json) as FormatUri;
}
export function marshal(payload: FormatUri): string {
  return JSON.stringify(payload);
}
export const theCodeGenSchema = {"type":"string","$schema":"http://json-schema.org/draft-07/schema","format":"uri","description":"String with URI format","$id":"FormatUri"};
