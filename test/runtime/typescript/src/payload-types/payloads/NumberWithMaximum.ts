...
export function unmarshal(json: string): NumberWithMaximum {
  return JSON.parse(json) as NumberWithMaximum;
}
export function marshal(payload: NumberWithMaximum): string {
  return JSON.stringify(payload);
}
export const theCodeGenSchema = {"type":"number","$schema":"http://json-schema.org/draft-07/schema","maximum":100,"description":"Number with maximum of 100","$id":"NumberWithMaximum"};
