...
export const theCodeGenSchema = {"$schema":"http://json-schema.org/draft-07/schema","oneOf":[{"type":"string"},{"type":"integer"}],"description":"OneOf with string or integer","$id":"OneOfTwoTypes"};
