...
export function unmarshal(json: string | any[]): StringArray {
  if (typeof json === 'string') {
    return JSON.parse(json) as StringArray;
  }
  return json as StringArray;
}
export function marshal(payload: StringArray): string {
  return JSON.stringify(payload);
}
export const theCodeGenSchema = {"type":"array","$schema":"http://json-schema.org/draft-07/schema","items":{"type":"string"},"description":"Array of strings","$id":"StringArray"};
