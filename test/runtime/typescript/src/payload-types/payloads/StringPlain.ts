...
export function unmarshal(json: string): StringPlain {
  return JSON.parse(json) as StringPlain;
}
export function marshal(payload: StringPlain): string {
  return JSON.stringify(payload);
}
export const theCodeGenSchema = {"type":"string","$schema":"http://json-schema.org/draft-07/schema","description":"A plain string type","$id":"StringPlain"};
