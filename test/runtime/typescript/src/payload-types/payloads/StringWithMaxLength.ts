...
/**
 * String with maximum length of 50
 */
type StringWithMaxLength = string;

export function unmarshal(json: string): StringWithMaxLength {
  return JSON.parse(json) as StringWithMaxLength;
}
export function marshal(payload: StringWithMaxLength): string {
  return JSON.stringify(payload);
}
export const theCodeGenSchema = {"type":"string","$schema":"http://json-schema.org/draft-07/schema","maxLength":50,"description":"String with maximum length of 50","$id":"StringWithMaxLength"};
