...
http_client: {
  async postPingPostRequest(context: {
    server?: string;
    payload: Ping;
    path?: string;
    bearerToken?: string;
...
async getPingGetRequest(context: {
    server?: string;
...
async putPingPutRequest(context: {
    server?: string;
...
async deletePingDeleteRequest(context: {
    server?: string;
...
async patchPingPatchRequest(context: {
    server?: string;
...
async headPingHeadRequest(context: {
    server?: string;
...
async optionsPingOptionsRequest(context: {
    server?: string;
...
async getMultiStatusResponse(context: {
    server?: string;
