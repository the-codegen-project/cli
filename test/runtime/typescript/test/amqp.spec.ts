...
const  {publishToSendUserSignedupQueue, publishToNoParameterQueue, publishToNoParameterExchange, publishToSendUserSignedupExchange, subscribeToReceiveUserSignedupQueue} = amqp;
    ...
    describe('with parameters', () => {
      it('should be able to publish to queue', () => {
        ...
        return new Promise<void>(async (resolve, reject) => {
          const channel = await subscribeToReceiveUserSignedupQueue((msg) => {
            if (msg !== null) {
